...
export interface IZeroExInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: '_fillLimitOrder', values: [LibNativeOrder.LimitOrderStruct, LibSignature.SignatureStruct, PromiseOrValue<BigNumberish>, PromiseOrValue<string>, PromiseOrValue<string>]): string;
    encodeFunctionData(functionFragment: '_fillOtcOrder', values: [LibNativeOrder.OtcOrderStruct, LibSignature.SignatureStruct, PromiseOrValue<BigNumberish>, PromiseOrValue<string>, PromiseOrValue<boolean>, PromiseOrValue<string>]): string;
    encodeFunctionData(functionFragment: '_fillRfqOrder', values: [LibNativeOrder.RfqOrderStruct, LibSignature.SignatureStruct, PromiseOrValue<BigNumberish>, PromiseOrValue<string>, PromiseOrValue<boolean>, PromiseOrValue<string>]): string;
    encodeFunctionData(functionFragment: '_sellHeldTokenForTokenToUniswapV3', values: [PromiseOrValue<BytesLike>, PromiseOrValue<BigNumberish>, PromiseOrValue<BigNumberish>, PromiseOrValue<string>]): string;
    encodeFunctionData(functionFragment: '_transformERC20', values: [ITransformERC20Feature.TransformERC20ArgsStruct]): string;
    encodeFunctionData(functionFragment: 'batchBuyERC1155s', values: [LibNFTOrder.ERC1155OrderStruct[], LibSignature.SignatureStruct[], PromiseOrValue<BigNumberish>[], PromiseOrValue<BytesLike>[], PromiseOrValue<boolean>]): string;
    encodeFunctionData(functionFragment: 'batchBuyERC721s', values: [LibNFTOrder.ERC721OrderStruct[], LibSignature.SignatureStruct[], PromiseOrValue<BytesLike>[], PromiseOrValue<boolean>]): string;
    ...
    encodeFunctionData(functionFragment: 'batchCancelPairLimitOrders', values: [PromiseOrValue<string>[], PromiseOrValue<string>[], PromiseOrValue<BigNumberish>[]]): string;
    encodeFunctionData(functionFragment: 'batchCancelPairLimitOrdersWithSigner', values: [PromiseOrValue<string>, PromiseOrValue<string>[], PromiseOrValue<string>[], PromiseOrValue<BigNumberish>[]]): string;
    encodeFunctionData(functionFragment: 'batchCancelPairRfqOrders', values: [PromiseOrValue<string>[], PromiseOrValue<string>[], PromiseOrValue<BigNumberish>[]]): string;
    encodeFunctionData(functionFragment: 'batchCancelPairRfqOrdersWithSigner', values: [PromiseOrValue<string>, PromiseOrValue<string>[], PromiseOrValue<string>[], PromiseOrValue<BigNumberish>[]]): string;
    ...
    encodeFunctionData(functionFragment: 'batchFillLimitOrders', values: [LibNativeOrder.LimitOrderStruct[], LibSignature.SignatureStruct[], PromiseOrValue<BigNumberish>[], PromiseOrValue<boolean>]): string;
    encodeFunctionData(functionFragment: 'batchFillRfqOrders', values: [LibNativeOrder.RfqOrderStruct[], LibSignature.SignatureStruct[], PromiseOrValue<BigNumberish>[], PromiseOrValue<boolean>]): string;
    encodeFunctionData(functionFragment: 'batchFillTakerSignedOtcOrders', values: [LibNativeOrder.OtcOrderStruct[], LibSignature.SignatureStruct[], LibSignature.SignatureStruct[], PromiseOrValue<boolean>[]]): string;
    ...
    encodeFunctionData(functionFragment: 'buyERC1155', values: [LibNFTOrder.ERC1155OrderStruct, LibSignature.SignatureStruct, PromiseOrValue<BigNumberish>, PromiseOrValue<BytesLike>]): string;
    encodeFunctionData(functionFragment: 'buyERC721', values: [LibNFTOrder.ERC721OrderStruct, LibSignature.SignatureStruct, PromiseOrValue<BytesLike>]): string;
    ...
    encodeFunctionData(functionFragment: 'cancelPairLimitOrders', values: [PromiseOrValue<string>, PromiseOrValue<string>, PromiseOrValue<BigNumberish>]): string;
    encodeFunctionData(functionFragment: 'cancelPairLimitOrdersWithSigner', values: [PromiseOrValue<string>, PromiseOrValue<string>, PromiseOrValue<string>, PromiseOrValue<BigNumberish>]): string;
    encodeFunctionData(functionFragment: 'cancelPairRfqOrders', values: [PromiseOrValue<string>, PromiseOrValue<string>, PromiseOrValue<BigNumberish>]): string;
    encodeFunctionData(functionFragment: 'cancelPairRfqOrdersWithSigner', values: [PromiseOrValue<string>, PromiseOrValue<string>, PromiseOrValue<string>, PromiseOrValue<BigNumberish>]): string;
    ...
    encodeFunctionData(functionFragment: 'fillLimitOrder', values: [LibNativeOrder.LimitOrderStruct, LibSignature.SignatureStruct, PromiseOrValue<BigNumberish>]): string;
    encodeFunctionData(functionFragment: 'fillOrKillLimitOrder', values: [LibNativeOrder.LimitOrderStruct, LibSignature.SignatureStruct, PromiseOrValue<BigNumberish>]): string;
    encodeFunctionData(functionFragment: 'fillOrKillRfqOrder', values: [LibNativeOrder.RfqOrderStruct, LibSignature.SignatureStruct, PromiseOrValue<BigNumberish>]): string;
    encodeFunctionData(functionFragment: 'fillOtcOrder', values: [LibNativeOrder.OtcOrderStruct, LibSignature.SignatureStruct, PromiseOrValue<BigNumberish>]): string;
    encodeFunctionData(functionFragment: 'fillOtcOrderForEth', values: [LibNativeOrder.OtcOrderStruct, LibSignature.SignatureStruct, PromiseOrValue<BigNumberish>]): string;
    ...
    encodeFunctionData(functionFragment: 'fillRfqOrder', values: [LibNativeOrder.RfqOrderStruct, LibSignature.SignatureStruct, PromiseOrValue<BigNumberish>]): string;
    ...
    encodeFunctionData(functionFragment: 'getERC721OrderStatusBitVector', values: [PromiseOrValue<string>, PromiseOrValue<BigNumberish>]): string;
    ...
    encodeFunctionData(functionFragment: 'getMetaTransactionHashExecutedBlock', values: [PromiseOrValue<BytesLike>]): string;
    ...
    encodeFunctionData(functionFragment: 'getRollbackEntryAtIndex', values: [PromiseOrValue<BytesLike>, PromiseOrValue<BigNumberish>]): string;
    ...
    encodeFunctionData(functionFragment: 'isValidOrderSigner', values: [PromiseOrValue<string>, PromiseOrValue<string>]): string;
    encodeFunctionData(functionFragment: 'lastOtcTxOriginNonce', values: [PromiseOrValue<string>, PromiseOrValue<BigNumberish>]): string;
    ...
    encodeFunctionData(functionFragment: 'migrate', values: [PromiseOrValue<string>, PromiseOrValue<BytesLike>, PromiseOrValue<string>]): string;
    encodeFunctionData(functionFragment: 'multiplexBatchSellEthForToken', values: [PromiseOrValue<string>, IMultiplexFeature.BatchSellSubcallStruct[], PromiseOrValue<BigNumberish>]): string;
    encodeFunctionData(functionFragment: 'multiplexBatchSellTokenForEth', values: [PromiseOrValue<string>, IMultiplexFeature.BatchSellSubcallStruct[], PromiseOrValue<BigNumberish>, PromiseOrValue<BigNumberish>]): string;
    encodeFunctionData(functionFragment: 'multiplexBatchSellTokenForToken', values: [PromiseOrValue<string>, PromiseOrValue<string>, IMultiplexFeature.BatchSellSubcallStruct[], PromiseOrValue<BigNumberish>, PromiseOrValue<BigNumberish>]): string;
    encodeFunctionData(functionFragment: 'multiplexMultiHopSellEthForToken', values: [PromiseOrValue<string>[], IMultiplexFeature.MultiHopSellSubcallStruct[], PromiseOrValue<BigNumberish>]): string;
    encodeFunctionData(functionFragment: 'multiplexMultiHopSellTokenForEth', values: [PromiseOrValue<string>[], IMultiplexFeature.MultiHopSellSubcallStruct[], PromiseOrValue<BigNumberish>, PromiseOrValue<BigNumberish>]): string;
    encodeFunctionData(functionFragment: 'multiplexMultiHopSellTokenForToken', values: [PromiseOrValue<string>[], IMultiplexFeature.MultiHopSellSubcallStruct[], PromiseOrValue<BigNumberish>, PromiseOrValue<BigNumberish>]): string;
    encodeFunctionData(functionFragment: 'onERC1155Received', values: [PromiseOrValue<string>, PromiseOrValue<string>, PromiseOrValue<BigNumberish>, PromiseOrValue<BigNumberish>, PromiseOrValue<BytesLike>]): string;
    ...
    encodeFunctionData(functionFragment: 'registerAllowedOrderSigner', values: [PromiseOrValue<string>, PromiseOrValue<boolean>]): string;
    encodeFunctionData(functionFragment: 'registerAllowedRfqOrigins', values: [PromiseOrValue<string>[], PromiseOrValue<boolean>]): string;
    encodeFunctionData(functionFragment: 'rollback', values: [PromiseOrValue<BytesLike>, PromiseOrValue<string>]): string;
    encodeFunctionData(functionFragment: 'sellERC1155', values: [LibNFTOrder.ERC1155OrderStruct, LibSignature.SignatureStruct, PromiseOrValue<BigNumberish>, PromiseOrValue<BigNumberish>, PromiseOrValue<boolean>, PromiseOrValue<BytesLike>]): string;
    encodeFunctionData(functionFragment: 'sellERC721', values: [LibNFTOrder.ERC721OrderStruct, LibSignature.SignatureStruct, PromiseOrValue<BigNumberish>, PromiseOrValue<boolean>, PromiseOrValue<BytesLike>]): string;
    encodeFunctionData(functionFragment: 'sellEthForTokenToUniswapV3', values: [PromiseOrValue<BytesLike>, PromiseOrValue<BigNumberish>, PromiseOrValue<string>]): string;
    encodeFunctionData(functionFragment: 'sellToLiquidityProvider', values: [PromiseOrValue<string>, PromiseOrValue<string>, PromiseOrValue<string>, PromiseOrValue<string>, PromiseOrValue<BigNumberish>, PromiseOrValue<BigNumberish>, PromiseOrValue<BytesLike>]): string;
    encodeFunctionData(functionFragment: 'sellToPancakeSwap', values: [PromiseOrValue<string>[], PromiseOrValue<BigNumberish>, PromiseOrValue<BigNumberish>, PromiseOrValue<BigNumberish>]): string;
    encodeFunctionData(functionFragment: 'sellToUniswap', values: [PromiseOrValue<string>[], PromiseOrValue<BigNumberish>, PromiseOrValue<BigNumberish>, PromiseOrValue<boolean>]): string;
    encodeFunctionData(functionFragment: 'sellTokenForEthToUniswapV3', values: [PromiseOrValue<BytesLike>, PromiseOrValue<BigNumberish>, PromiseOrValue<BigNumberish>, PromiseOrValue<string>]): string;
    encodeFunctionData(functionFragment: 'sellTokenForTokenToUniswapV3', values: [PromiseOrValue<BytesLike>, PromiseOrValue<BigNumberish>, PromiseOrValue<BigNumberish>, PromiseOrValue<string>]): string;
    ...
    encodeFunctionData(functionFragment: 'transferTrappedTokensTo', values: [PromiseOrValue<string>, PromiseOrValue<BigNumberish>, PromiseOrValue<string>]): string;
    encodeFunctionData(functionFragment: 'transformERC20', values: [PromiseOrValue<string>, PromiseOrValue<string>, PromiseOrValue<BigNumberish>, PromiseOrValue<BigNumberish>, ITransformERC20Feature.TransformationStruct[]]): string;
    encodeFunctionData(functionFragment: 'uniswapV3SwapCallback', values: [PromiseOrValue<BigNumberish>, PromiseOrValue<BigNumberish>, PromiseOrValue<BytesLike>]): string;
    encodeFunctionData(functionFragment: 'validateERC1155OrderProperties', values: [LibNFTOrder.ERC1155OrderStruct, PromiseOrValue<BigNumberish>]): string;
    ...
    encodeFunctionData(functionFragment: 'validateERC721OrderProperties', values: [LibNFTOrder.ERC721OrderStruct, PromiseOrValue<BigNumberish>]): string;
...
export interface IZeroEx extends BaseContract {
    ...
    functions: {
        _fillLimitOrder(order: LibNativeOrder.LimitOrderStruct, signature: LibSignature.SignatureStruct, takerTokenFillAmount: PromiseOrValue<BigNumberish>, taker: PromiseOrValue<string>, sender: PromiseOrValue<string>, overrides?: PayableOverrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        _fillOtcOrder(order: LibNativeOrder.OtcOrderStruct, makerSignature: LibSignature.SignatureStruct, takerTokenFillAmount: PromiseOrValue<BigNumberish>, taker: PromiseOrValue<string>, useSelfBalance: PromiseOrValue<boolean>, recipient: PromiseOrValue<string>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        _fillRfqOrder(order: LibNativeOrder.RfqOrderStruct, signature: LibSignature.SignatureStruct, takerTokenFillAmount: PromiseOrValue<BigNumberish>, taker: PromiseOrValue<string>, useSelfBalance: PromiseOrValue<boolean>, recipient: PromiseOrValue<string>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        _sellHeldTokenForTokenToUniswapV3(encodedPath: PromiseOrValue<BytesLike>, sellAmount: PromiseOrValue<BigNumberish>, minBuyAmount: PromiseOrValue<BigNumberish>, recipient: PromiseOrValue<string>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        _transformERC20(args: ITransformERC20Feature.TransformERC20ArgsStruct, overrides?: PayableOverrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        batchBuyERC1155s(sellOrders: LibNFTOrder.ERC1155OrderStruct[], signatures: LibSignature.SignatureStruct[], erc1155TokenAmounts: PromiseOrValue<BigNumberish>[], callbackData: PromiseOrValue<BytesLike>[], revertIfIncomplete: PromiseOrValue<boolean>, overrides?: PayableOverrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        batchBuyERC721s(sellOrders: LibNFTOrder.ERC721OrderStruct[], signatures: LibSignature.SignatureStruct[], callbackData: PromiseOrValue<BytesLike>[], revertIfIncomplete: PromiseOrValue<boolean>, overrides?: PayableOverrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        batchCancelERC1155Orders(orderNonces: PromiseOrValue<BigNumberish>[], overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        batchCancelERC721Orders(orderNonces: PromiseOrValue<BigNumberish>[], overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        batchCancelLimitOrders(orders: LibNativeOrder.LimitOrderStruct[], overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        batchCancelPairLimitOrders(makerTokens: PromiseOrValue<string>[], takerTokens: PromiseOrValue<string>[], minValidSalts: PromiseOrValue<BigNumberish>[], overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        batchCancelPairLimitOrdersWithSigner(maker: PromiseOrValue<string>, makerTokens: PromiseOrValue<string>[], takerTokens: PromiseOrValue<string>[], minValidSalts: PromiseOrValue<BigNumberish>[], overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        batchCancelPairRfqOrders(makerTokens: PromiseOrValue<string>[], takerTokens: PromiseOrValue<string>[], minValidSalts: PromiseOrValue<BigNumberish>[], overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        batchCancelPairRfqOrdersWithSigner(maker: PromiseOrValue<string>, makerTokens: PromiseOrValue<string>[], takerTokens: PromiseOrValue<string>[], minValidSalts: PromiseOrValue<BigNumberish>[], overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        ...
        batchFillLimitOrders(orders: LibNativeOrder.LimitOrderStruct[], signatures: LibSignature.SignatureStruct[], takerTokenFillAmounts: PromiseOrValue<BigNumberish>[], revertIfIncomplete: PromiseOrValue<boolean>, overrides?: PayableOverrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        batchFillRfqOrders(orders: LibNativeOrder.RfqOrderStruct[], signatures: LibSignature.SignatureStruct[], takerTokenFillAmounts: PromiseOrValue<BigNumberish>[], revertIfIncomplete: PromiseOrValue<boolean>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        batchFillTakerSignedOtcOrders(orders: LibNativeOrder.OtcOrderStruct[], makerSignatures: LibSignature.SignatureStruct[], takerSignatures: LibSignature.SignatureStruct[], unwrapWeth: PromiseOrValue<boolean>[], overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        ...
        buyERC1155(sellOrder: LibNFTOrder.ERC1155OrderStruct, signature: LibSignature.SignatureStruct, erc1155BuyAmount: PromiseOrValue<BigNumberish>, callbackData: PromiseOrValue<BytesLike>, overrides?: PayableOverrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        buyERC721(sellOrder: LibNFTOrder.ERC721OrderStruct, signature: LibSignature.SignatureStruct, callbackData: PromiseOrValue<BytesLike>, overrides?: PayableOverrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        cancelERC1155Order(orderNonce: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        cancelERC721Order(orderNonce: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        cancelLimitOrder(order: LibNativeOrder.LimitOrderStruct, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        cancelPairLimitOrders(makerToken: PromiseOrValue<string>, takerToken: PromiseOrValue<string>, minValidSalt: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        cancelPairLimitOrdersWithSigner(maker: PromiseOrValue<string>, makerToken: PromiseOrValue<string>, takerToken: PromiseOrValue<string>, minValidSalt: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        cancelPairRfqOrders(makerToken: PromiseOrValue<string>, takerToken: PromiseOrValue<string>, minValidSalt: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        cancelPairRfqOrdersWithSigner(maker: PromiseOrValue<string>, makerToken: PromiseOrValue<string>, takerToken: PromiseOrValue<string>, minValidSalt: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        ...
        extend(selector: PromiseOrValue<BytesLike>, impl: PromiseOrValue<string>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        fillLimitOrder(order: LibNativeOrder.LimitOrderStruct, signature: LibSignature.SignatureStruct, takerTokenFillAmount: PromiseOrValue<BigNumberish>, overrides?: PayableOverrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        fillOrKillLimitOrder(order: LibNativeOrder.LimitOrderStruct, signature: LibSignature.SignatureStruct, takerTokenFillAmount: PromiseOrValue<BigNumberish>, overrides?: PayableOverrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        fillOrKillRfqOrder(order: LibNativeOrder.RfqOrderStruct, signature: LibSignature.SignatureStruct, takerTokenFillAmount: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        fillOtcOrder(order: LibNativeOrder.OtcOrderStruct, makerSignature: LibSignature.SignatureStruct, takerTokenFillAmount: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        fillOtcOrderForEth(order: LibNativeOrder.OtcOrderStruct, makerSignature: LibSignature.SignatureStruct, takerTokenFillAmount: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        ...
        fillRfqOrder(order: LibNativeOrder.RfqOrderStruct, signature: LibSignature.SignatureStruct, takerTokenFillAmount: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        ...
        getERC721OrderStatusBitVector(maker: PromiseOrValue<string>, nonceRange: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<[BigNumber] & {
            bitVector: BigNumber;
        }>;
        ...
        getRollbackEntryAtIndex(selector: PromiseOrValue<BytesLike>, idx: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<[string] & {
            impl: string;
        }>;
        ...
        isValidOrderSigner(maker: PromiseOrValue<string>, signer: PromiseOrValue<string>, overrides?: CallOverrides): Promise<[boolean] & {
            isAllowed: boolean;
        }>;
        lastOtcTxOriginNonce(txOrigin: PromiseOrValue<string>, nonceBucket: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<[BigNumber] & {
            lastNonce: BigNumber;
        }>;
        ...
        migrate(target: PromiseOrValue<string>, data: PromiseOrValue<BytesLike>, newOwner: PromiseOrValue<string>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        multiplexBatchSellEthForToken(outputToken: PromiseOrValue<string>, calls: IMultiplexFeature.BatchSellSubcallStruct[], minBuyAmount: PromiseOrValue<BigNumberish>, overrides?: PayableOverrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        multiplexBatchSellTokenForEth(inputToken: PromiseOrValue<string>, calls: IMultiplexFeature.BatchSellSubcallStruct[], sellAmount: PromiseOrValue<BigNumberish>, minBuyAmount: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        multiplexBatchSellTokenForToken(inputToken: PromiseOrValue<string>, outputToken: PromiseOrValue<string>, calls: IMultiplexFeature.BatchSellSubcallStruct[], sellAmount: PromiseOrValue<BigNumberish>, minBuyAmount: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        multiplexMultiHopSellEthForToken(tokens: PromiseOrValue<string>[], calls: IMultiplexFeature.MultiHopSellSubcallStruct[], minBuyAmount: PromiseOrValue<BigNumberish>, overrides?: PayableOverrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        multiplexMultiHopSellTokenForEth(tokens: PromiseOrValue<string>[], calls: IMultiplexFeature.MultiHopSellSubcallStruct[], sellAmount: PromiseOrValue<BigNumberish>, minBuyAmount: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        multiplexMultiHopSellTokenForToken(tokens: PromiseOrValue<string>[], calls: IMultiplexFeature.MultiHopSellSubcallStruct[], sellAmount: PromiseOrValue<BigNumberish>, minBuyAmount: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        onERC1155Received(operator: PromiseOrValue<string>, from: PromiseOrValue<string>, tokenId: PromiseOrValue<BigNumberish>, value: PromiseOrValue<BigNumberish>, data: PromiseOrValue<BytesLike>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        ...
        registerAllowedOrderSigner(signer: PromiseOrValue<string>, allowed: PromiseOrValue<boolean>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        registerAllowedRfqOrigins(origins: PromiseOrValue<string>[], allowed: PromiseOrValue<boolean>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        rollback(selector: PromiseOrValue<BytesLike>, targetImpl: PromiseOrValue<string>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        sellERC1155(buyOrder: LibNFTOrder.ERC1155OrderStruct, signature: LibSignature.SignatureStruct, erc1155TokenId: PromiseOrValue<BigNumberish>, erc1155SellAmount: PromiseOrValue<BigNumberish>, unwrapNativeToken: PromiseOrValue<boolean>, callbackData: PromiseOrValue<BytesLike>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        sellERC721(buyOrder: LibNFTOrder.ERC721OrderStruct, signature: LibSignature.SignatureStruct, erc721TokenId: PromiseOrValue<BigNumberish>, unwrapNativeToken: PromiseOrValue<boolean>, callbackData: PromiseOrValue<BytesLike>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        sellEthForTokenToUniswapV3(encodedPath: PromiseOrValue<BytesLike>, minBuyAmount: PromiseOrValue<BigNumberish>, recipient: PromiseOrValue<string>, overrides?: PayableOverrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        sellToLiquidityProvider(inputToken: PromiseOrValue<string>, outputToken: PromiseOrValue<string>, provider: PromiseOrValue<string>, recipient: PromiseOrValue<string>, sellAmount: PromiseOrValue<BigNumberish>, minBuyAmount: PromiseOrValue<BigNumberish>, auxiliaryData: PromiseOrValue<BytesLike>, overrides?: PayableOverrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        sellToPancakeSwap(tokens: PromiseOrValue<string>[], sellAmount: PromiseOrValue<BigNumberish>, minBuyAmount: PromiseOrValue<BigNumberish>, fork: PromiseOrValue<BigNumberish>, overrides?: PayableOverrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        sellToUniswap(tokens: PromiseOrValue<string>[], sellAmount: PromiseOrValue<BigNumberish>, minBuyAmount: PromiseOrValue<BigNumberish>, isSushi: PromiseOrValue<boolean>, overrides?: PayableOverrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        sellTokenForEthToUniswapV3(encodedPath: PromiseOrValue<BytesLike>, sellAmount: PromiseOrValue<BigNumberish>, minBuyAmount: PromiseOrValue<BigNumberish>, recipient: PromiseOrValue<string>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        sellTokenForTokenToUniswapV3(encodedPath: PromiseOrValue<BytesLike>, sellAmount: PromiseOrValue<BigNumberish>, minBuyAmount: PromiseOrValue<BigNumberish>, recipient: PromiseOrValue<string>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        setQuoteSigner(quoteSigner: PromiseOrValue<string>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        setTransformerDeployer(transformerDeployer: PromiseOrValue<string>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        ...
        transferProtocolFeesForPools(poolIds: PromiseOrValue<BytesLike>[], overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        transferTrappedTokensTo(erc20: PromiseOrValue<string>, amountOut: PromiseOrValue<BigNumberish>, recipientWallet: PromiseOrValue<string>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        transformERC20(inputToken: PromiseOrValue<string>, outputToken: PromiseOrValue<string>, inputTokenAmount: PromiseOrValue<BigNumberish>, minOutputTokenAmount: PromiseOrValue<BigNumberish>, transformations: ITransformERC20Feature.TransformationStruct[], overrides?: PayableOverrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        ...
        validateERC1155OrderProperties(order: LibNFTOrder.ERC1155OrderStruct, erc1155TokenId: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<[void]>;
        ...
        validateERC721OrderProperties(order: LibNFTOrder.ERC721OrderStruct, erc721TokenId: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<[void]>;
    ...
    validateERC721OrderSignature(order: LibNFTOrder.ERC721OrderStruct, signature: LibSignature.SignatureStruct, overrides?: CallOverrides): Promise<void>;
    callStatic: {
        _fillLimitOrder(order: LibNativeOrder.LimitOrderStruct, signature: LibSignature.SignatureStruct, takerTokenFillAmount: PromiseOrValue<BigNumberish>, taker: PromiseOrValue<string>, sender: PromiseOrValue<string>, overrides?: CallOverrides): Promise<[BigNumber, BigNumber] & {
            takerTokenFilledAmount: BigNumber;
            makerTokenFilledAmount: BigNumber;
        }>;
        _fillOtcOrder(order: LibNativeOrder.OtcOrderStruct, makerSignature: LibSignature.SignatureStruct, takerTokenFillAmount: PromiseOrValue<BigNumberish>, taker: PromiseOrValue<string>, useSelfBalance: PromiseOrValue<boolean>, recipient: PromiseOrValue<string>, overrides?: CallOverrides): Promise<[BigNumber, BigNumber] & {
            takerTokenFilledAmount: BigNumber;
            makerTokenFilledAmount: BigNumber;
        }>;
        _fillRfqOrder(order: LibNativeOrder.RfqOrderStruct, signature: LibSignature.SignatureStruct, takerTokenFillAmount: PromiseOrValue<BigNumberish>, taker: PromiseOrValue<string>, useSelfBalance: PromiseOrValue<boolean>, recipient: PromiseOrValue<string>, overrides?: CallOverrides): Promise<[BigNumber, BigNumber] & {
            takerTokenFilledAmount: BigNumber;
            makerTokenFilledAmount: BigNumber;
        }>;
        _sellHeldTokenForTokenToUniswapV3(encodedPath: PromiseOrValue<BytesLike>, sellAmount: PromiseOrValue<BigNumberish>, minBuyAmount: PromiseOrValue<BigNumberish>, recipient: PromiseOrValue<string>, overrides?: CallOverrides): Promise<BigNumber>;
        _transformERC20(args: ITransformERC20Feature.TransformERC20ArgsStruct, overrides?: CallOverrides): Promise<BigNumber>;
        batchBuyERC1155s(sellOrders: LibNFTOrder.ERC1155OrderStruct[], signatures: LibSignature.SignatureStruct[], erc1155TokenAmounts: PromiseOrValue<BigNumberish>[], callbackData: PromiseOrValue<BytesLike>[], revertIfIncomplete: PromiseOrValue<boolean>, overrides?: CallOverrides): Promise<boolean[]>;
        batchBuyERC721s(sellOrders: LibNFTOrder.ERC721OrderStruct[], signatures: LibSignature.SignatureStruct[], callbackData: PromiseOrValue<BytesLike>[], revertIfIncomplete: PromiseOrValue<boolean>, overrides?: CallOverrides): Promise<boolean[]>;
        ...
        batchCancelPairLimitOrders(makerTokens: PromiseOrValue<string>[], takerTokens: PromiseOrValue<string>[], minValidSalts: PromiseOrValue<BigNumberish>[], overrides?: CallOverrides): Promise<void>;
        batchCancelPairLimitOrdersWithSigner(maker: PromiseOrValue<string>, makerTokens: PromiseOrValue<string>[], takerTokens: PromiseOrValue<string>[], minValidSalts: PromiseOrValue<BigNumberish>[], overrides?: CallOverrides): Promise<void>;
        batchCancelPairRfqOrders(makerTokens: PromiseOrValue<string>[], takerTokens: PromiseOrValue<string>[], minValidSalts: PromiseOrValue<BigNumberish>[], overrides?: CallOverrides): Promise<void>;
        batchCancelPairRfqOrdersWithSigner(maker: PromiseOrValue<string>, makerTokens: PromiseOrValue<string>[], takerTokens: PromiseOrValue<string>[], minValidSalts: PromiseOrValue<BigNumberish>[], overrides?: CallOverrides): Promise<void>;
        ...
        batchFillLimitOrders(orders: LibNativeOrder.LimitOrderStruct[], signatures: LibSignature.SignatureStruct[], takerTokenFillAmounts: PromiseOrValue<BigNumberish>[], revertIfIncomplete: PromiseOrValue<boolean>, overrides?: CallOverrides): Promise<[BigNumber[], BigNumber[]] & {
            takerTokenFilledAmounts: BigNumber[];
            makerTokenFilledAmounts: BigNumber[];
        }>;
        batchFillRfqOrders(orders: LibNativeOrder.RfqOrderStruct[], signatures: LibSignature.SignatureStruct[], takerTokenFillAmounts: PromiseOrValue<BigNumberish>[], revertIfIncomplete: PromiseOrValue<boolean>, overrides?: CallOverrides): Promise<[BigNumber[], BigNumber[]] & {
            takerTokenFilledAmounts: BigNumber[];
            makerTokenFilledAmounts: BigNumber[];
        }>;
        batchFillTakerSignedOtcOrders(orders: LibNativeOrder.OtcOrderStruct[], makerSignatures: LibSignature.SignatureStruct[], takerSignatures: LibSignature.SignatureStruct[], unwrapWeth: PromiseOrValue<boolean>[], overrides?: CallOverrides): Promise<boolean[]>;
        batchGetLimitOrderRelevantStates(orders: LibNativeOrder.LimitOrderStruct[], signatures: LibSignature.SignatureStruct[], overrides?: CallOverrides): Promise<[LibNativeOrder.OrderInfoStructOutput[], BigNumber[], boolean[]] & {
            orderInfos: LibNativeOrder.OrderInfoStructOutput[];
            actualFillableTakerTokenAmounts: BigNumber[];
            isSignatureValids: boolean[];
        ...
        buyERC1155(sellOrder: LibNFTOrder.ERC1155OrderStruct, signature: LibSignature.SignatureStruct, erc1155BuyAmount: PromiseOrValue<BigNumberish>, callbackData: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<void>;
        buyERC721(sellOrder: LibNFTOrder.ERC721OrderStruct, signature: LibSignature.SignatureStruct, callbackData: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<void>;
        ...
        cancelPairLimitOrders(makerToken: PromiseOrValue<string>, takerToken: PromiseOrValue<string>, minValidSalt: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<void>;
        cancelPairLimitOrdersWithSigner(maker: PromiseOrValue<string>, makerToken: PromiseOrValue<string>, takerToken: PromiseOrValue<string>, minValidSalt: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<void>;
        cancelPairRfqOrders(makerToken: PromiseOrValue<string>, takerToken: PromiseOrValue<string>, minValidSalt: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<void>;
        cancelPairRfqOrdersWithSigner(maker: PromiseOrValue<string>, makerToken: PromiseOrValue<string>, takerToken: PromiseOrValue<string>, minValidSalt: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<void>;
        ...
        fillLimitOrder(order: LibNativeOrder.LimitOrderStruct, signature: LibSignature.SignatureStruct, takerTokenFillAmount: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<[BigNumber, BigNumber] & {
            takerTokenFilledAmount: BigNumber;
            makerTokenFilledAmount: BigNumber;
        }>;
        fillOrKillLimitOrder(order: LibNativeOrder.LimitOrderStruct, signature: LibSignature.SignatureStruct, takerTokenFillAmount: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<BigNumber>;
        fillOrKillRfqOrder(order: LibNativeOrder.RfqOrderStruct, signature: LibSignature.SignatureStruct, takerTokenFillAmount: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<BigNumber>;
        fillOtcOrder(order: LibNativeOrder.OtcOrderStruct, makerSignature: LibSignature.SignatureStruct, takerTokenFillAmount: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<[BigNumber, BigNumber] & {
            takerTokenFilledAmount: BigNumber;
            makerTokenFilledAmount: BigNumber;
        }>;
        fillOtcOrderForEth(order: LibNativeOrder.OtcOrderStruct, makerSignature: LibSignature.SignatureStruct, takerTokenFillAmount: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<[BigNumber, BigNumber] & {
            takerTokenFilledAmount: BigNumber;
            makerTokenFilledAmount: BigNumber;
        }>;
        ...
        fillRfqOrder(order: LibNativeOrder.RfqOrderStruct, signature: LibSignature.SignatureStruct, takerTokenFillAmount: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<[BigNumber, BigNumber] & {
            takerTokenFilledAmount: BigNumber;
            makerTokenFilledAmount: BigNumber;
        }>;
        ...
        migrate(target: PromiseOrValue<string>, data: PromiseOrValue<BytesLike>, newOwner: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>;
        multiplexBatchSellEthForToken(outputToken: PromiseOrValue<string>, calls: IMultiplexFeature.BatchSellSubcallStruct[], minBuyAmount: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<BigNumber>;
        multiplexBatchSellTokenForEth(inputToken: PromiseOrValue<string>, calls: IMultiplexFeature.BatchSellSubcallStruct[], sellAmount: PromiseOrValue<BigNumberish>, minBuyAmount: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<BigNumber>;
        multiplexBatchSellTokenForToken(inputToken: PromiseOrValue<string>, outputToken: PromiseOrValue<string>, calls: IMultiplexFeature.BatchSellSubcallStruct[], sellAmount: PromiseOrValue<BigNumberish>, minBuyAmount: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<BigNumber>;
        multiplexMultiHopSellEthForToken(tokens: PromiseOrValue<string>[], calls: IMultiplexFeature.MultiHopSellSubcallStruct[], minBuyAmount: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<BigNumber>;
        multiplexMultiHopSellTokenForEth(tokens: PromiseOrValue<string>[], calls: IMultiplexFeature.MultiHopSellSubcallStruct[], sellAmount: PromiseOrValue<BigNumberish>, minBuyAmount: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<BigNumber>;
        multiplexMultiHopSellTokenForToken(tokens: PromiseOrValue<string>[], calls: IMultiplexFeature.MultiHopSellSubcallStruct[], sellAmount: PromiseOrValue<BigNumberish>, minBuyAmount: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<BigNumber>;
        onERC1155Received(operator: PromiseOrValue<string>, from: PromiseOrValue<string>, tokenId: PromiseOrValue<BigNumberish>, value: PromiseOrValue<BigNumberish>, data: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<string>;
        ...
        registerAllowedOrderSigner(signer: PromiseOrValue<string>, allowed: PromiseOrValue<boolean>, overrides?: CallOverrides): Promise<void>;
        registerAllowedRfqOrigins(origins: PromiseOrValue<string>[], allowed: PromiseOrValue<boolean>, overrides?: CallOverrides): Promise<void>;
        rollback(selector: PromiseOrValue<BytesLike>, targetImpl: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>;
        sellERC1155(buyOrder: LibNFTOrder.ERC1155OrderStruct, signature: LibSignature.SignatureStruct, erc1155TokenId: PromiseOrValue<BigNumberish>, erc1155SellAmount: PromiseOrValue<BigNumberish>, unwrapNativeToken: PromiseOrValue<boolean>, callbackData: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<void>;
        sellERC721(buyOrder: LibNFTOrder.ERC721OrderStruct, signature: LibSignature.SignatureStruct, erc721TokenId: PromiseOrValue<BigNumberish>, unwrapNativeToken: PromiseOrValue<boolean>, callbackData: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<void>;
        sellEthForTokenToUniswapV3(encodedPath: PromiseOrValue<BytesLike>, minBuyAmount: PromiseOrValue<BigNumberish>, recipient: PromiseOrValue<string>, overrides?: CallOverrides): Promise<BigNumber>;
        sellToLiquidityProvider(inputToken: PromiseOrValue<string>, outputToken: PromiseOrValue<string>, provider: PromiseOrValue<string>, recipient: PromiseOrValue<string>, sellAmount: PromiseOrValue<BigNumberish>, minBuyAmount: PromiseOrValue<BigNumberish>, auxiliaryData: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<BigNumber>;
        sellToPancakeSwap(tokens: PromiseOrValue<string>[], sellAmount: PromiseOrValue<BigNumberish>, minBuyAmount: PromiseOrValue<BigNumberish>, fork: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<BigNumber>;
        sellToUniswap(tokens: PromiseOrValue<string>[], sellAmount: PromiseOrValue<BigNumberish>, minBuyAmount: PromiseOrValue<BigNumberish>, isSushi: PromiseOrValue<boolean>, overrides?: CallOverrides): Promise<BigNumber>;
        sellTokenForEthToUniswapV3(encodedPath: PromiseOrValue<BytesLike>, sellAmount: PromiseOrValue<BigNumberish>, minBuyAmount: PromiseOrValue<BigNumberish>, recipient: PromiseOrValue<string>, overrides?: CallOverrides): Promise<BigNumber>;
        sellTokenForTokenToUniswapV3(encodedPath: PromiseOrValue<BytesLike>, sellAmount: PromiseOrValue<BigNumberish>, minBuyAmount: PromiseOrValue<BigNumberish>, recipient: PromiseOrValue<string>, overrides?: CallOverrides): Promise<BigNumber>;
        ...
        transferTrappedTokensTo(erc20: PromiseOrValue<string>, amountOut: PromiseOrValue<BigNumberish>, recipientWallet: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>;
        transformERC20(inputToken: PromiseOrValue<string>, outputToken: PromiseOrValue<string>, inputTokenAmount: PromiseOrValue<BigNumberish>, minOutputTokenAmount: PromiseOrValue<BigNumberish>, transformations: ITransformERC20Feature.TransformationStruct[], overrides?: CallOverrides): Promise<BigNumber>;
    ...
    filters: {
        ...
        'MetaTransactionExecuted(bytes32,bytes4,address,address)'(hash?: null, selector?: PromiseOrValue<BytesLike> | null, signer?: null, sender?: null): MetaTransactionExecutedEventFilter;
        MetaTransactionExecuted(hash?: null, selector?: PromiseOrValue<BytesLike> | null, signer?: null, sender?: null): MetaTransactionExecutedEventFilter;
        ...
        'ProxyFunctionUpdated(bytes4,address,address)'(selector?: PromiseOrValue<BytesLike> | null, oldImpl?: null, newImpl?: null): ProxyFunctionUpdatedEventFilter;
        ProxyFunctionUpdated(selector?: PromiseOrValue<BytesLike> | null, oldImpl?: null, newImpl?: null): ProxyFunctionUpdatedEventFilter;
        ...
        'TransformedERC20(address,address,address,uint256,uint256)'(taker?: PromiseOrValue<string> | null, inputToken?: null, outputToken?: null, inputTokenAmount?: null, outputTokenAmount?: null): TransformedERC20EventFilter;
        TransformedERC20(taker?: PromiseOrValue<string> | null, inputToken?: null, outputToken?: null, inputTokenAmount?: null, outputTokenAmount?: null): TransformedERC20EventFilter;
    ...
    estimateGas: {
        ...
        getRollbackEntryAtIndex(selector: PromiseOrValue<BytesLike>, idx: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<BigNumber>;
        getRollbackLength(selector: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<BigNumber>;
        ...
        isValidOrderSigner(maker: PromiseOrValue<string>, signer: PromiseOrValue<string>, overrides?: CallOverrides): Promise<BigNumber>;
        lastOtcTxOriginNonce(txOrigin: PromiseOrValue<string>, nonceBucket: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<BigNumber>;
        matchERC721Orders(sellOrder: LibNFTOrder.ERC721OrderStruct, buyOrder: LibNFTOrder.ERC721OrderStruct, sellOrderSignature: LibSignature.SignatureStruct, buyOrderSignature: LibSignature.SignatureStruct, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<BigNumber>;
        ...
        validateERC1155OrderProperties(order: LibNFTOrder.ERC1155OrderStruct, erc1155TokenId: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<BigNumber>;
        ...
        validateERC721OrderProperties(order: LibNFTOrder.ERC721OrderStruct, erc721TokenId: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        getERC721OrderStatusBitVector(maker: PromiseOrValue<string>, nonceRange: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        ...
        getMetaTransactionHashExecutedBlock(mtxHash: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        ...
        getRollbackEntryAtIndex(selector: PromiseOrValue<BytesLike>, idx: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        ...
        isValidOrderSigner(maker: PromiseOrValue<string>, signer: PromiseOrValue<string>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        lastOtcTxOriginNonce(txOrigin: PromiseOrValue<string>, nonceBucket: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        matchERC721Orders(sellOrder: LibNFTOrder.ERC721OrderStruct, buyOrder: LibNFTOrder.ERC721OrderStruct, sellOrderSignature: LibSignature.SignatureStruct, buyOrderSignature: LibSignature.SignatureStruct, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<PopulatedTransaction>;
        migrate(target: PromiseOrValue<string>, data: PromiseOrValue<BytesLike>, newOwner: PromiseOrValue<string>, overrides?: Overrides & {
        ...
        validateERC1155OrderProperties(order: LibNFTOrder.ERC1155OrderStruct, erc1155TokenId: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        ...
        validateERC721OrderProperties(order: LibNFTOrder.ERC721OrderStruct, erc721TokenId: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<PopulatedTransaction>;

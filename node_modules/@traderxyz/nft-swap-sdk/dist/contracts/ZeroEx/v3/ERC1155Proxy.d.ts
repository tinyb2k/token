...
export interface ERC1155ProxyInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: 'removeAuthorizedAddressAtIndex', values: [PromiseOrValue<string>, PromiseOrValue<BigNumberish>]): string;
    encodeFunctionData(functionFragment: 'transferFrom', values: [PromiseOrValue<BytesLike>, PromiseOrValue<string>, PromiseOrValue<string>, PromiseOrValue<BigNumberish>]): string;
...
export interface ERC1155Proxy extends BaseContract {
    ...
    functions: {
        addAuthorizedAddress(target: PromiseOrValue<string>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        authorities(arg0: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<[string]>;
        removeAuthorizedAddress(target: PromiseOrValue<string>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        owner(overrides?: CallOverrides): Promise<[string]>;
        removeAuthorizedAddressAtIndex(target: PromiseOrValue<string>, index: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        transferFrom(assetData: PromiseOrValue<BytesLike>, from: PromiseOrValue<string>, to: PromiseOrValue<string>, amount: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        owner(overrides?: CallOverrides): Promise<string>;
        removeAuthorizedAddressAtIndex(target: PromiseOrValue<string>, index: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<void>;
        transferFrom(assetData: PromiseOrValue<BytesLike>, from: PromiseOrValue<string>, to: PromiseOrValue<string>, amount: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<void>;
        getProxyId(overrides?: CallOverrides): Promise<string>;
        authorized(arg0: PromiseOrValue<string>, overrides?: CallOverrides): Promise<boolean>;
        getAuthorizedAddresses(overrides?: CallOverrides): Promise<string[]>;
    ...
    filters: {
        'AuthorizedAddressAdded(address,address)'(target?: PromiseOrValue<string> | null, caller?: PromiseOrValue<string> | null): AuthorizedAddressAddedEventFilter;
        AuthorizedAddressAdded(target?: PromiseOrValue<string> | null, caller?: PromiseOrValue<string> | null): AuthorizedAddressAddedEventFilter;
        'AuthorizedAddressRemoved(address,address)'(target?: PromiseOrValue<string> | null, caller?: PromiseOrValue<string> | null): AuthorizedAddressRemovedEventFilter;
        AuthorizedAddressRemoved(target?: PromiseOrValue<string> | null, caller?: PromiseOrValue<string> | null): AuthorizedAddressRemovedEventFilter;
    };
    estimateGas: {
        addAuthorizedAddress(target: PromiseOrValue<string>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;

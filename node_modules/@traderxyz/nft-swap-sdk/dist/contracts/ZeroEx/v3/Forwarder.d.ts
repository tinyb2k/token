...
export interface ForwarderInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: 'approveMakerAssetProxy', values: [PromiseOrValue<BytesLike>]): string;
    encodeFunctionData(functionFragment: 'marketBuyOrdersWithEth', values: [LibOrder.OrderStruct[], PromiseOrValue<BigNumberish>, PromiseOrValue<BytesLike>[], PromiseOrValue<BigNumberish>[], PromiseOrValue<string>[]]): string;
    encodeFunctionData(functionFragment: 'marketSellAmountWithEth', values: [LibOrder.OrderStruct[], PromiseOrValue<BigNumberish>, PromiseOrValue<BytesLike>[], PromiseOrValue<BigNumberish>[], PromiseOrValue<string>[]]): string;
    encodeFunctionData(functionFragment: 'marketSellOrdersWithEth', values: [LibOrder.OrderStruct[], PromiseOrValue<BytesLike>[], PromiseOrValue<BigNumberish>[], PromiseOrValue<string>[]]): string;
    encodeFunctionData(functionFragment: 'onERC1155BatchReceived', values: [PromiseOrValue<string>, PromiseOrValue<string>, PromiseOrValue<BigNumberish>[], PromiseOrValue<BigNumberish>[], PromiseOrValue<BytesLike>]): string;
    ...
    encodeFunctionData(functionFragment: 'withdrawAsset', values: [PromiseOrValue<BytesLike>, PromiseOrValue<BigNumberish>]): string;
...
export interface Forwarder extends BaseContract {
    ...
    functions: {
        ...
        approveMakerAssetProxy(assetData: PromiseOrValue<BytesLike>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        marketBuyOrdersWithEth(orders: LibOrder.OrderStruct[], makerAssetBuyAmount: PromiseOrValue<BigNumberish>, signatures: PromiseOrValue<BytesLike>[], ethFeeAmounts: PromiseOrValue<BigNumberish>[], feeRecipients: PromiseOrValue<string>[], overrides?: PayableOverrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        marketSellAmountWithEth(orders: LibOrder.OrderStruct[], ethSellAmount: PromiseOrValue<BigNumberish>, signatures: PromiseOrValue<BytesLike>[], ethFeeAmounts: PromiseOrValue<BigNumberish>[], feeRecipients: PromiseOrValue<string>[], overrides?: PayableOverrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        marketSellOrdersWithEth(orders: LibOrder.OrderStruct[], signatures: PromiseOrValue<BytesLike>[], ethFeeAmounts: PromiseOrValue<BigNumberish>[], feeRecipients: PromiseOrValue<string>[], overrides?: PayableOverrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        ...
        withdrawAsset(assetData: PromiseOrValue<BytesLike>, amount: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    };
    ERC1155_BATCH_RECEIVED(overrides?: CallOverrides): Promise<string>;
    ...
    callStatic: {
        ...
        ERC1155_RECEIVED(overrides?: CallOverrides): Promise<string>;
        EXCHANGE_V2_ORDER_ID(overrides?: CallOverrides): Promise<string>;
        approveMakerAssetProxy(assetData: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<void>;
        marketBuyOrdersWithEth(orders: LibOrder.OrderStruct[], makerAssetBuyAmount: PromiseOrValue<BigNumberish>, signatures: PromiseOrValue<BytesLike>[], ethFeeAmounts: PromiseOrValue<BigNumberish>[], feeRecipients: PromiseOrValue<string>[], overrides?: CallOverrides): Promise<[BigNumber, BigNumber] & {
            wethSpentAmount: BigNumber;
            makerAssetAcquiredAmount: BigNumber;
        }>;
        marketSellAmountWithEth(orders: LibOrder.OrderStruct[], ethSellAmount: PromiseOrValue<BigNumberish>, signatures: PromiseOrValue<BytesLike>[], ethFeeAmounts: PromiseOrValue<BigNumberish>[], feeRecipients: PromiseOrValue<string>[], overrides?: CallOverrides): Promise<[BigNumber, BigNumber] & {
            wethSpentAmount: BigNumber;
            makerAssetAcquiredAmount: BigNumber;
        }>;
        marketSellOrdersWithEth(orders: LibOrder.OrderStruct[], signatures: PromiseOrValue<BytesLike>[], ethFeeAmounts: PromiseOrValue<BigNumberish>[], feeRecipients: PromiseOrValue<string>[], overrides?: CallOverrides): Promise<[BigNumber, BigNumber] & {
            wethSpentAmount: BigNumber;
            makerAssetAcquiredAmount: BigNumber;
        }>;
        ...
        withdrawAsset(assetData: PromiseOrValue<BytesLike>, amount: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<void>;
    };
    filters: {

...
export interface MultiAssetProxyInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: 'assetProxies', values: [PromiseOrValue<BytesLike>]): string;
...
export interface MultiAssetProxy extends BaseContract {
    ...
    functions: {
        assetProxies(arg0: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<[string]>;
    ...
    estimateGas: {
        assetProxies(arg0: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<BigNumber>;
        addAuthorizedAddress(target: PromiseOrValue<string>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<BigNumber>;
    ...
    populateTransaction: {
        assetProxies(arg0: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        addAuthorizedAddress(target: PromiseOrValue<string>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
